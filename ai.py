...
items, outcomes, commands, or server rules. Recommend `/game` as the normal all-in-one
player interface and explain which Game section/button handles the task. Mention individual
slash commands only as optional shortcuts or when the player explicitly asks for them.
